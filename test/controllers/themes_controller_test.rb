...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference("Theme.count") do
      post themes_url, params: { theme: { theme_descr: @theme.theme_descr, theme_title: @theme.theme_title } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { theme_descr: @theme.theme_descr, theme_title: @theme.theme_title } }
